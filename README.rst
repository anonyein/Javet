...
* Node.js ``v26.10.0`` + V8 ``v15.4.80.9``
* i18n and non-i18n
...
.. code-block:: kotlin
    ...
    implementation("com.caoccao.javet:javet:6.0.2") // Core (Must-have)
...
* `What does V8 Sandbox Really Mean in Javet <https://blog.caoccao.com/what-does-v8-sandbox-really-mean-in-javet-dc0072846b8b>`_
